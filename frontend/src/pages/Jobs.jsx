...
import { LOCATION_TYPES, PLATFORMS, FRESHNESS_OPTIONS } from '../constants/jobTypes';
...
export default function Jobs() {
  // Default view: freshest 3 days, best matches first.
  const [filters, setFilters] = useState({ locationType: '', platform: '', minScore: 0, q: '', sort: 'score', postedWithinDays: '3' });
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Card className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Select options={FRESHNESS_OPTIONS} value={filters.postedWithinDays} onChange={(e) => update('postedWithinDays', e.target.value)} />
